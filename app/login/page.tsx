        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl shadow-sm border border-slate-200/80 p-8">
            <div className="mb-7">
              ...
              <p className="text-slate-500 text-sm mt-1.5">Enter your credentials below to continue</p>
            </div>
            ...
            {locked ? (
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <h3 className="font-semibold text-slate-900 mb-1.5">Account Temporarily Locked</h3>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    placeholder="••••••••"
                    {...register('password')}
                    className={`h-10 rounded-lg ${errors.password ? 'border-red-400' : ''}`}
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button type="button" className="text-sm text-blue-600 hover:text-blue-700 font-medium transition-colors cursor-pointer">
                    Forgot password?
                  </button>
                </div>
          ...
          {!locked && (
            <div className="mt-5 p-4 rounded-xl bg-white shadow-sm border border-slate-200/80">
              <p className="text-xs font-semibold text-slate-500 mb-3 uppercase tracking-wider">Role access summary</p>
